...
export class Basetheme {
  ...
  inputBorderRadiusSmall = this.p("--sl-input-border-radius-small", `0.5rem`)
  inputBorderRadiusMedium = this.p("--sl-input-border-radius-medium", `0.5rem`)
  inputBorderRadiusLarge = this.p("--sl-input-border-radius-large", `0.5rem`)
